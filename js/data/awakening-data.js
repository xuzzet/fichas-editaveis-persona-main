// =============================================
// DESPERTAR TRAMA — DADOS ESTATICOS DAS ARCANAS
// Somente dados/estruturas puras (sem estado, DOM ou logica).
// Extraido de js/awakening.js para modularizacao.
// Depende de: (nenhum modulo)
// =============================================
...
export const TIER_KEYS = ['main', 'amp1', 'amp2'];
export const TIER_LABELS = ['Habilidade Principal', 'Amplificação I', 'Amplificação II'];
